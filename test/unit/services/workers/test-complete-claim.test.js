...
describe('services/workers/complete-claim', () => {
  it('should call to retrieve, copy and delete first time claim, calculate car expenses, run auto-approval checks, insert notification and DWP check tasks', () => {
