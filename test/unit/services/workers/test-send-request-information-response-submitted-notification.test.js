...
const sendRequestInformationResponseSubmittedNotification = require('../../../../app/services/workers/send-request-information-response-submitted-notification')

describe('services/send-request-information-response-submitted-notification', () => {
    ...
    return sendRequestInformationResponseSubmittedNotification
      ...
      .then(() => {
        ...
        expect(mockSendNotification.mock.calls[0][0]).toBe(
          config.NOTIFY_REQUEST_INFORMATION_RESPONSE_SUBMITTED_EMAIL_TEMPLATE_ID,
        )
