...
const expectedClaimIds = [116501, 123456, 997878, 125787]

describe('services/workers/helpers/payments/get-claim-ids-from-payment-data', () => {
  it('should return a 1-dimensional array of claim Ids', () => {
