...
describe('services/workers/cleanup-old-payment-files', () => {
  it('should get old payment files, delete them, and update their IsEnabled status', () => {
    return cleanupOldPaymentFiles.cleanupOldPaymentFiles().then(() => {
