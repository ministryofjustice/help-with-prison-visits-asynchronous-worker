...
describe('services/getWorkerForTask', () => {
  ...
  it('should return send-request-information-response-submitted-notification', () => {
  ...
  it('should return send-advance-claim-evidence-reminder-notification', () => {
  ...
  it('should return send-updated-contact-details-claim-notification', () => {
