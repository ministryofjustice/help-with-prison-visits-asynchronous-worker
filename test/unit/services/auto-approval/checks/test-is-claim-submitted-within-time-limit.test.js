...
describe('services/auto-approval/checks/is-claim-submitted-within-time-limit', () => {
  it('should return true while this check is disabled as per HWPV-177', () => {
    const checkResult = isClaimSubmittedWithinTimeLimit('')
    expect(checkResult.result).toBe(true)
  })

  // it('should return true if the submission date is less than or equal to maxDayAfterAPVUVisit days after the date of journey of last manually approved claim', () => {
  //   const checkResult = isClaimSubmittedWithinTimeLimit(validAutoApprovalData)
  //   expect(checkResult.result).toBe(true)
  // })

  // it('should return false if the submission date is greater than maxDayAfterAPVUVisit days after the date of journey of last manually approved claim', () => {
