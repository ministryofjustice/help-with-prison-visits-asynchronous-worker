...
describe('services/auto-approval/checks/is-visit-in-past', () => {
  it('should return true if the visit date of the current claim is in the past', () => {
    const checkResult = isVisitInPast(autoApprovalDataWithPastClaim)
    expect(checkResult.result).toBe(true)
  })

  it('should return false if the visit date of the current claim is in the future', () => {
