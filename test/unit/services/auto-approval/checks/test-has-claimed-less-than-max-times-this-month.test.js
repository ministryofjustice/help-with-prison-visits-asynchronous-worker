...
describe('services/auto-approval/checks/has-claimed-less-than-max-times-this-month', () => {
  it(`should return false if the number of claims made for the current month is greater than ${MAX_NUMBER_OF_CLAIMS_PER_MONTH}`, () => {
  ...
  it(`should return true if the number of claims made for the current month is equal to ${MAX_NUMBER_OF_CLAIMS_PER_MONTH}`, () => {
    const firstOfCurrentMonth = dateFormatter.now().startOf('month')
  ...
  it(`should return true if the number of claims made for the current month is less than ${MAX_NUMBER_OF_CLAIMS_PER_MONTH}`, () => {
    const firstOfCurrentMonth = dateFormatter.now().startOf('month')
  ...
  it('should return true if the number of claims made for the current month is zero', () => {
  ...
  it('should return true if the claimant has claimed the max number of claims this month, and submits an advance claim that falls outside the claimable month', () => {
    const firstOfCurrentMonth = dateFormatter.now().startOf('month')
