...
describe('services/auto-approval/checks/cost-and-variance-equal-or-less-than-first-time-claim', () => {
  it('should return true if the total cost for each expense type is within the accepted variance (10%)', () => {
  ...
  it('should return false if the total cost of any expense type is outside the accepted variance (10%)', () => {
    autoApprovalData.ClaimExpenses = [
      {
        ExpenseType: 'plane',
        Cost: 115,
