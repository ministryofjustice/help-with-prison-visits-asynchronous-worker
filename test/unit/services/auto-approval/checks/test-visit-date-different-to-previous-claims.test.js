...
describe('services/auto-approval/checks/visit-date-different-to-previous-claims', () => {
  it('should return true if none of the previous claims have the same visit date as the current claim', () => {
    const checkResult = visitDateDifferentToPreviousClaims(validAutoApprovalData)
    expect(checkResult.result).toBe(true)
  })

  it('should return false if any of the previous claims have the same visit date as the current claim', () => {
  ...
  it('should return true if there are no previous claims', () => {
