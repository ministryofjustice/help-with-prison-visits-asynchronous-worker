...
describe('services/auto-approval/checks/do-expenses-match-first-time-claim', () => {
  it('should return false if the number of expenses of the same type exceeds the number of expenses for the same type in the first time claim', () => {
  ...
  it("should return false if claim types of the current claim don't exist in the first time claim expenses", () => {
    autoApprovalData.ClaimExpenses = [
      {
        ExpenseType: 'taxi',
      },
  ...
  it('should return true if the number of expenses of the same type is less or equal than the number of expenses for the same type in the first time claim', () => {
    autoApprovalData.ClaimExpenses = [
      {
        ExpenseType: 'plane',
      },
  ...
  it('should return false if there is no first time claim expenses', () => {
