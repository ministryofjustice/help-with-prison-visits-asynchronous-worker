...
const CLAIM_DATA = { DeleteEligibility: false, Claim: { Reference: REFERENCE, EligibilityId: ELIGIBILITY_ID, ClaimId: CLAIM_ID } }
const CLAIM_DATA_DELETE_ELIGIBILTIY = { DeleteEligibility: true, Claim: { Reference: REFERENCE, EligibilityId: ELIGIBILITY_ID, ClaimId: CLAIM_ID } }
