...
// Sco Total = 21.22
// Wales Total = 20.00
describe('services/direct-payments/create-payment-file', () => {
  it('should generate valid APVU AccessPay file with correct header', () => {
    return createPaymentFile(data, true).then(filePath => {
  ...
  it('should generate valid SSCL AccessPay file with correct header', () => {
    return createPaymentFile(data, false).then(filePath => {
      expect(filePath).not.toBeNull()
      testFilePath = filePath
