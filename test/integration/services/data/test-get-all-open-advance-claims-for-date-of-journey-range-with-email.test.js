...
describe('services/data/get-all-open-advance-claims-for-date-of-journey-range-with-email', () => {
  beforeAll(() => {
  ...
  it('should return open advanced claims for the date of journey range', () => {
    return getAllOpenAdvanceClaimsForDateOfJourneyRangeWithEmail(START_DATE, END_DATE).then(claims => {
