...
describe('services/data/get-all-claims-older-than-date', () => {
  beforeAll(() => {
  ...
  it('should return claims with date reviewed older than date', () => {
    return getAllClaimsOldersThanDate(olderThanDate).then(claimIds => {
      const expectedClaimIds = claimIds.filter(result => {
