module.exports = {
  ...
  DAILY_TASKS_CRON: process.env.APVS_DAILY_TASKS_CRON || '30 30 04 * * *', // default every day at 0430
  ...
  // Payment Generation
  PAYMENT_GENERATION_CRON: process.env.APVS_PAYMENT_GENERATION_CRON || '10 00 00 * * 0-4',
