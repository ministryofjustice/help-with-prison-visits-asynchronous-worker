module.exports = {
  ...
  // Worker
  ASYNC_WORKER_CRON: process.env.APVS_ASYNC_WORKER_CRON || '*/5 * * * * *', // default every 5 seconds (every minute * * * * *)
  ASYNC_WORKER_BATCH_SIZE: process.env.APVS_ASYNC_WORKER_BATCH_SIZE || '5',
  DAILY_TASKS_CRON: process.env.APVS_DAILY_TASKS_CRON || '00 30 04 * * *', // default every day at 0430 (30 4 * * *)
  AUTO_APPROVAL_CRON: process.env.APVS_AUTO_APPROVAL_CRON || '00 00 10 * * 1-5', // default every working day at 1000 (0 10 * * 1-5)
  ...
  // Payment Generation
  PAYMENT_GENERATION_CRON: process.env.APVS_PAYMENT_GENERATION_CRON || '00 05 00 * * 1-5', // default Mon-Fri at 00:05 (5 0 * * 1-5)
