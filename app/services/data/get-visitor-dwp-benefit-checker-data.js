...
module.exports = function (reference, eligibilityId, claimId) {
  return knex('IntSchema.Eligibility')
    ...
    .first('IntSchema.Visitor.VisitorId', 'IntSchema.Visitor.LastName', 'IntSchema.Visitor.NationalInsuranceNumber', 'IntSchema.Visitor.DateOfBirth', 'IntSchema.Visitor.Benefit')
